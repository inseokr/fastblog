        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                Group {
                    ...
                    bodyText("Please read these Terms of Service carefully before using Bloggo. By accessing or using our service, you agree to be bound by these terms.")
                }
                ...
                Group {
                    ...
                    bodyText("For questions about these Terms, contact us at bloggo@linkedspaces.com or through our support page.")
                }
